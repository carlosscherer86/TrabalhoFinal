...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        disable: function () {
            ...
            self.$container.find(".btn-file, .fileinput-remove, .file-preview-frame button").attr("disabled",
                true);
            self.initDragDrop();
        },
        enable: function () {
            ...
            self.$container.find(".btn-file, .fileinput-remove, .file-preview-frame button").removeAttr("disabled");
            self.initDragDrop();
        },
        ...
        uploadSingle: function (i, files, allFiles) {
            var self = this, total = self.getFileStack().length, formdata = new FormData(), outData,
                ...
                pct, chkComplete, $btnDelete = $thumb.find('.kv-file-remove'),
